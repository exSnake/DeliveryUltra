...
public class DBMysql extends Database {
	...
	@Override
	public boolean accettaOrdine(Ordine ordine) throws Exception {
	...
	@Override
	public boolean consegnaOrdine(Ordine ordine, String nominativo) throws Exception {
		boolean queryRes = false;
		Connection conn = openConnection();
	...
	@Override
	public boolean eliminaOrdine(Ordine ordine) throws Exception{
		boolean queryRes = false;
		Connection conn = openConnection();
		conn.setAutoCommit(false);
		if (conn == null) return false;
	...
	@Override
	public List<Ordine> getOrdiniByRistorante(Ristorante ristorante) throws Exception {
		List<Ordine> ordini = new ArrayList<>();
		Connection conn = openConnection();
		if (conn == null) return ordini;
	...
	@Override
	public List<Ordine> getOrdiniInCoda() throws Exception {
		List<Ordine> ordini = new ArrayList<>();
		Connection conn = openConnection();
		if (conn == null) return ordini;
		try (Statement stmt = conn.createStatement()) {
	...
	@Override
	public List<Ordine> getOrdiniInCodaByRistorante(Ristorante ristorante) throws Exception {
		List<Ordine> ordini = new ArrayList<>();
		Connection conn = openConnection();
		if (conn == null) return ordini;
	...
	@Override
	public List<Persona> getPersoneByRistoranteId(int ristoranteId) throws Exception {
